defmodule TaiShangNftGalleryWeb.EnsureRolePlug do
  @moduledoc """
  This plug ensures that a user has a particular role.

  ## Example

      plug TaiShangNftGalleryWeb.EnsureRolePlug, [:user, :admin]

      plug TaiShangNftGalleryWeb.EnsureRolePlug, :admin

      plug TaiShangNftGalleryWeb.EnsureRolePlug, ~w(user admin)a
  """
