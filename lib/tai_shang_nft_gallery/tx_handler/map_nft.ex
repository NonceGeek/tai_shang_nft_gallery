defmodule TaiShangNftGallery.TxHandler.MapNft do
  ...
  def do_handle_tx("claim", %{id: nft_c_id, addr: addr} = nft_contract, from, _to, _value, [block_height, token_info], tx_hash, chain) do
